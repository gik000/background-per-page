...
$meta_boxes[] = array(
	...
	'pages' => array( 'post', 'page', 'bpp_settings', 'portfolio', 'twocol_type'),
	...
	'fields' => array(
		...
		array(
			...
			'std'		=> 'auto',
			'desc'		=> 'The background-size property (see <a href="http://www.w3schools.com/cssref/css3_pr_background-size.asp">w3cschools.</a>)'
		),
		array(
			'name'		=> 'Fade?',
			'id'		=> "{$prefix}fade",
...
function get_data($id){
	...
	$bg_size = get_post_meta( $id, '_bpp_background_size', true );
